const C='fin-v6';
self.addEventListener('install',e=>{e.waitUntil(caches.open(C).then(c=>c.addAll(['./','./index.html','./icon-192.png','./icon-512.png','./icon-180.png','./favicon.ico','./manifest.json'])).then(()=>self.skipWaiting()))});
